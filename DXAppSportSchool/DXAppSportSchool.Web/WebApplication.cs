...
namespace DXAppSportSchool.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class DXAppSportSchoolAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private DXAppSportSchool.Module.DXAppSportSchoolModule module3;
        private DXAppSportSchool.Module.Web.DXAppSportSchoolAspNetModule module4;
        ...
        public DXAppSportSchoolAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void DXAppSportSchoolAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new DXAppSportSchool.Module.DXAppSportSchoolModule();
            this.module4 = new DXAppSportSchool.Module.Web.DXAppSportSchoolAspNetModule();
            ...
            this.securityStrategyComplex1.UserType = typeof(DXAppSportSchool.Module.BusinessObjects.ApplicationUser);
            // 
            // securityModule1
            // 
            this.securityModule1.UserType = typeof(DXAppSportSchool.Module.BusinessObjects.ApplicationUser);
            // 
            ...
            this.authenticationActiveDirectory1.UserLoginInfoType = typeof(DXAppSportSchool.Module.BusinessObjects.ApplicationUserLoginInfo);
            //
            // dashboardsModule
            //
            ...
            // 
            // DXAppSportSchoolAspNetApplication
            // 
            this.ApplicationName = "DXAppSportSchool";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.DXAppSportSchoolAspNetApplication_DatabaseVersionMismatch);
